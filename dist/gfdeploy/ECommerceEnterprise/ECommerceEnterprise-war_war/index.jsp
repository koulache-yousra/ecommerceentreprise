...
<body>
    ...
    <script>
        ...
        const demoAccounts = [
            { email: 'ahmed@email.com', password: 'password123', type: 'client' },
            { email: 'admin@ecommerce.dz', password: 'admin123', type: 'admin' }
        ];
        
        // Remplir automatiquement avec un compte de démo
        document.addEventListener('DOMContentLoaded', function() {
            const emailField = document.getElementById('email');
            const passwordField = document.getElementById('password');
            
            // Remplir avec le premier compte de démo
            emailField.value = demoAccounts[0].email;
            passwordField.value = demoAccounts[0].password;
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            // Simulation de la connexion (dans un vrai projet, ça serait une requête AJAX)
            setTimeout(() => {
        ...
        function showNotification(message, type = 'info') {
            ...
            notification.style.background = type === 'error' ? '#ef4444' : 'var(--primary)';
        ...
        document.querySelectorAll('.demo-value').forEach((element, index) => {
            element.style.cursor = 'pointer';
            element.addEventListener('click', function() {
                const accountIndex = Math.floor(index / 2); // 0 pour client, 1 pour admin
                const account = demoAccounts[accountIndex];
                
                document.getElementById('email').value = account.email;
                document.getElementById('password').value = account.password;
                
                showNotification(`Compte ${account.type} chargé`, 'info');
            });
        });
        
        // Effet sur le focus des champs
